    ...
    internal sealed class Configuration : DbMigrationsConfiguration<eStore.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(eStore.Models.ApplicationDbContext context)
        {
            var products = new Product[] {
                ...
                new Product {Image="http://www.secondnaturepillow.com/images/albums/NewAlbum_28ac1/tn_480_3pil3.jpg.jpg", Name="Neck Pillow", Price=29.00m, Filling="buckwheat", Fabric="solid", Description="Neck Pillow product description..."}
        };
